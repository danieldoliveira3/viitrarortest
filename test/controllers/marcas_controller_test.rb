...
class MarcasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create marca" do
    assert_difference('Marca.count') do
      post marcas_url, params: { marca: { carros: @marca.carros, criado_em: @marca.criado_em, nome: @marca.nome, user_id: @marca.user_id } }, as: :json
    end
  ...
  test "should update marca" do
    patch marca_url(@marca), params: { marca: { carros: @marca.carros, criado_em: @marca.criado_em, nome: @marca.nome, user_id: @marca.user_id } }, as: :json
    assert_response 200
  end
